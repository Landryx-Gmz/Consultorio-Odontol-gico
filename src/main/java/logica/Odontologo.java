...
public class Odontologo extends Persona{
   ...
   public Odontologo() {
    ...
    public Odontologo(String especialidad, List<Turno> listaTrurnos, Usuario unUsuario, Horario unHorario, int id, String dni, String nombre, String apellido, String direccion, Date fecha_nac) {
