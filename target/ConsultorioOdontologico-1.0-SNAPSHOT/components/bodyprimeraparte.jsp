...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu Odontólogos -->
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Ver Odont;ologos</a>
                        <a class="collapse-item" href="altaOdontologo.jsp">Alta Odontólogos</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - Utilities Collapse Menu Pacientes-->
            <li class="nav-item">
            ...
            <!-- Nav Item - Utilities Collapse Menu Usuarios -->
            <li class="nav-item">
